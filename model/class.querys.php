<?php
	...
	class Querys{
		...
		public function procedures(){
			$sql = "CALL cargar_productor_entidad(:user,:clave)";

			$PDOmodel = new conexion();
			$conn = $PDOmodel->get_conexion();
			$statement = $conn->prepare($sql);
			$statement->bindParam(':user', 'josem', PDO::PARAM_STR|PDO::PARAM_INPUT_OUTPUT);
			$statement->bindParam(':clave', 'joseito', PDO::PARAM_STR|PDO::PARAM_INPUT_OUTPUT);
