    ...
    <div class="container-fluid h-100">
      ...
      <div class="main-content row h-100">
        <div class="barra_lateral col-12 col-sm auto">
          <!--.d-none.d-sm-block-->
          <nav>
            <div class="leyenda"><a href="./dashboard">Principal</a><span> / </span><a href="./seguimiento">Seguimiento</a></div>
            <ul>
              <li><a class="flaticon-escritura" href="#">Acondicionamiento</a></li>
              <li><a class="flaticon-tractor" href="#">Siembra</a></li>
              <li><a class="flaticon-escritura" href="#">Cosecha</a></li>
              <li><a class="flaticon-numero-de-seguimiento" href="#">Producción</a></li>
