...
<html class="h-100" lang="es">
    ...
    <div class="container-fluid h-100">
      ...
      <div class="main-content row h-100">
        <div class="barra_lateral col-12 col-md-auto">
          <nav>
            <div class="leyenda"><a href="./dashboard">Principal</a><span> / </span><a href="./archivos">Archivos</a><span> / Ciclos</span></div>
            <ul>
        ...
        <main class="contenido col">
          <div class="row m-0">
            ...
            <section class="col-12 col-lg">
              <div class="card" id="cont-ciclos">
                <h3 class="flaticon-recycle-water">Ciclo de Cosecha</h3>
                <ul class="nav nav-tabs d-none" id="tabciclos" roles="tablist">
                ...
                <div class="tab-content" id="contenidoTabciclos">
                  <div class="tab-pane fade show active" id="list" role="tabpanel">
                    <h4>Resumen de ciclos										</h4>
                    <div class="table-responsive">
                      <table class="tabla-ciclos table table-striped table-hover" id="tabla">
                        <thead>
                          <tr>
                            <th>#</th>
                            <th>Codigo</th>
                  ...
                  <div class="tab-pane fade show" id="new" role="tabpanel">
                    ...
                    <form class="form-module" id="fCiclo" action="#" method="post" name="ciclos" autocomplete="off">
                      <div class="row m-0">
                        <div class="col-12 col-sm-4 p-1">
                          <label class="custom-label" for="codCiclo">Ciclo de cosecha</label>
                          <select class="custom-select" id="codCiclo">
                            <option value="">Ciclo de cosecha</option>
                            <option value="INV-Invierno">Invierno</option>
                            <option value="VER-Verano">Verano</option>
                            <option value="CLG-Ciclo Largo">Ciclo Largo</option>
                          </select>
                        </div>
                        <div class="col-12 col-sm p-1">
                          <label class="custom-label" for="desCiclo">Descripción</label>
                          <input id="desCiclo" type="text" name="desCiclo" placeholder="Descripción" maxlength="50" readonly>
                        </div>
                        <div class="w-100"></div>
                        <div class="col-12 col-sm p-1">
                          <label class="custom-label" for="cicloDesde">Desde</label>
                          <input class="fciclo" id="cicloDesde" type="date" name="cicloDesde">
                        </div>
                        <div class="col-12 col-sm p-1">
                          <label class="custom-label" for="cicloHasta">Hasta</label>
                          <input class="fciclo" id="cicloHasta" type="date" name="cicloHasta">
                        </div>
                        <div class="w-100"></div>
                        <div class="col-12 col-sm p-1">
                          <div class="custom-control custom-switch">
                            <input class="custom-control-input" id="switchCiclo" type="checkbox" name="">
                            <label class="custom-control-label" for="switchCiclo">Activo/Inactivo</label>
                          </div>
                        </div>
                        <div class="w-100"></div>
                        ...
                        <!--.col-auto.px-1.mt-2input#btnClean.b-style-cancel(type="button" value="Cancelar")
                        -->
                        <div class="col-auto p-0 pl-1 mt-2">
                          <input class="b-style-color3 load" id="btnRegCiclo" type="submit" value="Guardar">
                        </div>
                      </div>
                    </form>
                  </div>
        ...
        <div class="row m-0 position-fixed h-100" id="boxNew">
          <div class="align-self-end" id="boxButtons">
            ...
            <div class="item-button">
              <label>Nuevo ciclo de cosecha</label><a class="flaticon-recycle-water" href="javascript:void(0)" onclick="main.hideBoxNew(), js('#tabNew').click()"></a>
            </div>
          </div>
  ...
  <script src="js/class.ciclos.js"></script>
  <script>
    var main = new Main();
