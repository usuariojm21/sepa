...
<html class="h-100" lang="es">
    ...
    <div class="container-fluid h-100">
      ...
      <div class="main-content row h-100">
        <div class="barra_lateral col-12 col-md-auto">
          <nav>
            <div class="leyenda"><a href="./dashboard">Principal</a><span> / </span><a href="./archivos">Archivos</a><span> / Productores</span></div>
            <ul>
          ...
          <div class="row m-0">
            <section class="col-12" id="migasdepan">
              <div class="leyenda"><a href="./dashboard">Principal</a><span> > </span><a href="./archivos">Archivos</a><span>
                   > <b>Productores</b></span></div>
            </section>
            <section class="col-12 col-lg">
              <div class="card" id="cont-productores">
                <h3 class="flaticon-agricultor">Productor/Empresa</h3><br>
                ...
                <div class="tab-content" id="contenidoTabproductores">
                  <div class="tab-pane fade show active" id="list" role="tabpanel">
                    <h4>Productores registrados</h4>
                    <div class="table-responsive">
                      <table class="tabla-productores table table-striped table-hover" id="tabla">
                        <thead>
                          <tr>
                            <th>#</th>
                            <th>C.I./Rif</th>
                  ...
                  <div class="tab-pane fade" id="new" role="tabpanel">
                    ...
                    <form class="form-module" id="fproductor" action="#" method="post" autocomplete="off">
                      <div class="row m-0">
                        ...
                        <div class="col-12 p-1">
                          ...
                          <input class="large-control no-valid" id="dfiscal" type="text" name="dfiscal" maxlength="255">
                        </div>
                        <div class="col-12 p-1">
        ...
        <div class="row m-0 position-fixed h-100" id="boxNew">
          <div class="align-self-end" id="boxButtons">
            ...
            <div class="item-button">
              <label>Unidad de Producción</label><a class="flaticon-siembra" href="./unidad_produccion"></a>
            </div>
            <div class="item-button primary">
              <label>Nuevo productor</label><a class="flaticon-agricultor" href="javascript:void(0)" onclick="main.hideBoxNew(), js('#tabNew').click()"></a>
            </div>
          </div>
        </div>
      </div>
  ...
  <script src="js/class.productores.js"></script>
  <script>
    var main = new Main();
