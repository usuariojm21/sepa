    ...
    <div class="container-fluid h-100">
      ...
      <div class="main-content row h-100">
        <div class="barra_lateral col-12 col-sm auto">
          <!--.d-none.d-sm-block-->
          <nav>
            <div class="leyenda"><a href="./dashboard">Principal</a><span> / </span><a href="./preguiado">Pre-guiado</a></div>
            <ul>
              <li><a class="flaticon-escritura" href="#">Emisión</a></li>
              <li><a class="flaticon-tractor" href="#">Revisión</a></li>
              <li><a class="flaticon-escritura" href="#">Recepción</a></li>
